...
if __name__ == '__main__' :
    ...
    date = 'august04'
    day = min_max.daily_min_max[date]

    global_chan1_max = day.global_chan1_max
    global_chan1_min = day.global_chan1_min
    global_chan2_max = day.global_chan2_max
    global_chan2_min = day.global_chan2_min
